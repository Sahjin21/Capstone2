...
public class patientEditInfoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String firstName = request.getParameter("firstNme");
            String lastName = request.getParameter("lastNme");
            ...
            d1.updatePatientDB(patID, passwrd, firstName, lastName, email, phone);
